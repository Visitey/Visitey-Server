...
from rest_friendship.signals import (
...
class FriendshipRequest(models.Model):
    ...
    to_user = models.ForeignKey(Profile, related_name='friendship_requests_received', on_delete=models.CASCADE)
...
class Friend(models.Model):
    ...
    from_user = models.ForeignKey(Profile, related_name='_unused_friend_relation', on_delete=models.CASCADE)
