...
class Profile(models.Model):
    ...
    gender_regex = RegexValidator(regex=r'(?i)^male$|^female$', message="Gender must be 'male' or 'female'")
    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$', message="Phone number must be entered in the format: "
                                                                   "'+999999999'. Up to 15 digits allowed.")
    relationship_regex = RegexValidator(regex=r"(?i)^single$|^in a relationship$|^engaged$|^married$|^it's "
                                        ...
                                        message="Relationship must be : 'Single','In a Relationship', 'Engaged', "
                                                ...
                                                "'Widowed', " "'Separated', 'Divorced', 'In a Civil Union,'")
    ...
    relationship = models.CharField(max_length=40, default='', blank=True, validators=(relationship_regex,))
